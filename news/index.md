...
- Fixed CRAN Debian check failure:
  [`detect_chars_structure_datasets()`](../reference/detect_chars_structure_datasets.md)
  example and tests no longer write to the installed package directory.
  All file outputs now use
  [`tempdir()`](https://rdrr.io/r/base/tempfile.html) with proper
  cleanup.
